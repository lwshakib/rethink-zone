...
const featureCards = [
    {
        ...
        description: 'Edit structured docs while sketching on an infinite canvas without switching tabs.',
        icon: LayoutPanelLeft,
    },
    {
        title: 'Move ideas to delivery',
        description: 'Track work with the built-in kanban board so brainstorms become shipped tasks.',
        icon: Kanban,
    },
    {
        title: 'Rich writing experience',
        description: 'Slash commands, block-based editing, and autosave keep notes fast and dependable.',
        icon: FilePenLine,
    },
    {
        title: 'Secure by default',
        description: 'Authentication, protected routes, and database-backed workspaces out of the box.',
        icon: ShieldCheck,
    },
    {
        title: 'Realtime-ready UX',
        description: 'Smooth motion, optimistic UI, and saved state so teams stay in flow.',
        icon: Sparkles,
    },
    {
        title: 'Visual collaboration',
        description: 'Drop diagrams, stickies, and arrows to map flows before you commit to code.',
        icon: ArrowRight,
    },
]
                            ...
                            <div className="sm:mx-auto lg:mr-auto lg:mt-0">
                                <div className="flex flex-wrap items-center gap-3">
                                    ...
                                    <div className="flex flex-wrap gap-2 text-xs text-muted-foreground">
                                        <span className="rounded-full border border-border/60 px-3 py-1">Docs + Canvas</span>
                                        <span className="rounded-full border border-border/60 px-3 py-1">Kanban built-in</span>
                                        <span className="rounded-full border border-border/60 px-3 py-1">Autosave & auth</span>
                                    </div>
                                </div>
                                <TextEffect
                                    preset="fade-in-blur"
                                ...
                                <TextEffect
                                    ...
                                    Rethink Zone combines rich documents, an infinite canvas, and a kanban board so product teams can capture ideas, align decisions, and move work forward without losing context.
                                </TextEffect>
                ...
                <section id="features" className="bg-background pb-10 pt-16 md:pb-24">
                    <div className="mx-auto max-w-5xl px-6">
                        <div className="flex items-center justify-between gap-4">
                            <div>
                                <p className="text-sm font-medium text-foreground/80">Why teams pick Rethink Zone</p>
                                <p className="text-muted-foreground mt-1 text-sm">Purpose-built for the document, canvas, and kanban flow already in the app.</p>
                            </div>
                            <Link
                                href="/workspaces"
                        ...
                        <div className="grid gap-8 rounded-3xl border bg-gradient-to-br from-foreground/[0.03] via-transparent to-foreground/[0.04] p-8 md:grid-cols-[1.2fr_1fr] md:p-10">
                            <div className="space-y-4">
                                ...
                                <h3 className="text-3xl font-semibold leading-tight">
                                    Capture ideas, design collaboratively, and organize delivery without leaving your workspace.
                                </h3>
                                <p className="text-muted-foreground text-base">
                                    The landing page now mirrors the core product: documents for clarity, a whiteboard for exploration, and a kanban board for execution.
                                </p>
                                <div className="grid gap-4 sm:grid-cols-3">
                                    {steps.map((step) => (
                                        <div key={step.title} className="rounded-2xl border bg-background/80 p-4">
                                ...
                                <div className="flex flex-wrap gap-3 pt-2">
                                    <Badge variant="outline" className="rounded-full border-foreground/20 text-foreground/90">
                                        Clerk auth baked in
                                    </Badge>
                                    <Badge variant="outline" className="rounded-full border-foreground/20 text-foreground/90">
                            ...
                            <div className="flex flex-col gap-4 rounded-2xl border bg-background/50 p-6 shadow-sm">
                                <p className="text-sm font-semibold text-foreground/80">What you get</p>
                                <ul className="space-y-3 text-sm text-muted-foreground">
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1 size-1.5 rounded-full bg-emerald-500" />
                                        Split tab that shows document and canvas simultaneously so decisions stay connected.
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1 size-1.5 rounded-full bg-sky-500" />
                                        Kanban that saves automatically as your boards change, matching the in-app experience.
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1 size-1.5 rounded-full bg-indigo-500" />
                                        Authenticated entry points (`/sign-in`, `/sign-up`) routing directly into `/workspaces`.
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1 size-1.5 rounded-full bg-amber-500" />
                                        Motion-powered hero with preview screens that align with the product UI.
                                    </li>
                                </ul>
                ...
                <section id="views" className="bg-background pb-20">
                    <div className="mx-auto max-w-5xl px-6">
                        <div className="flex flex-wrap items-center justify-between gap-4">
                            <div>
                                <p className="text-sm font-semibold text-foreground/80">Workspace views</p>
                                <p className="text-muted-foreground mt-1 text-sm">Every view in the product has a landing-page twin so visitors know what they get.</p>
                            </div>
                        ...
                        <div className="mt-10 grid gap-6 md:grid-cols-2">
                            {[
                                ...
                                <div key={card.title} className="rounded-2xl border bg-gradient-to-b from-background to-foreground/[0.02] p-5 shadow-sm">
                ...
                <section id="guardrails" className="bg-background pb-20">
                    <div className="mx-auto max-w-5xl px-6">
                        <div className="grid gap-8 rounded-3xl border bg-gradient-to-tr from-foreground/[0.03] via-transparent to-foreground/[0.04] p-8 md:grid-cols-[1.1fr_0.9fr] md:p-10">
                            <div className="space-y-4">
                                <p className="text-sm font-semibold text-foreground/80">Built-in guardrails</p>
                                <h3 className="text-3xl font-semibold leading-tight">Secure, performant, and ready to onboard teams.</h3>
                                <ul className="space-y-3 text-sm text-muted-foreground">
                                    <li className="flex items-start gap-2">
                                        <CheckCircle2 className="mt-0.5 size-4 text-emerald-500" />
                                        Clerk authentication and protected routes keep workspaces private by default.
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <Database className="mt-0.5 size-4 text-sky-500" />
                                        Drizzle ORM + API routes persist documents, canvas data, and kanban boards.
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <Zap className="mt-0.5 size-4 text-amber-500" />
                                        Autosave with optimistic updates mirrors the in-app behavior shown above.
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <UsersRound className="mt-0.5 size-4 text-indigo-500" />
                                        Multi-tab navigation (document, canvas, both, kanban) for every workspace.
                                    </li>
                                </ul>
                                <div className="flex flex-wrap gap-3">
                                    <Badge className="rounded-full bg-foreground text-background">Ships fast</Badge>
                                    <Badge variant="outline" className="rounded-full border-foreground/20 text-foreground/90">
                                        Motion-first UI
                                    </Badge>
                                    <Badge variant="outline" className="rounded-full border-foreground/20 text-foreground/90">
                            ...
                            <div className="rounded-2xl border bg-background/70 p-6 shadow-sm">
                                <p className="text-sm font-semibold text-foreground/80">In-product snapshot</p>
                                <div className="mt-4 space-y-4 text-sm text-muted-foreground">
                                    <p>From the landing page, users jump into authenticated flows at `/sign-up` or `/sign-in`, then land in `/workspaces` with autosaved boards.</p>
                                    <p>The detail page mirrors the tabs shown here: Both, Document, Canvas, and Kanban—so expectations match reality.</p>
                                    <p>Calls to action link directly to those routes to reduce bounce and shorten time-to-value.</p>
                                </div>
                        ...
                        <div className="rounded-3xl border bg-gradient-to-r from-foreground/[0.03] to-transparent p-8 md:p-10">
                            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                                <div className="space-y-2">
                                    <p className="text-sm font-semibold text-foreground/80">Pricing</p>
                                    <h3 className="text-3xl font-semibold leading-tight">Start free, grow with your team.</h3>
                                    <p className="text-muted-foreground text-base">
                                        Unlimited drafts while you explore. Upgrade when you invite teammates and need more storage.
                                    </p>
                                </div>
                                <div className="rounded-2xl border bg-background/70 p-6 shadow-sm">
                                    <p className="text-sm font-medium text-foreground/80">Team</p>
                                    <p className="mt-2 text-3xl font-semibold">$12<span className="text-base text-muted-foreground"> / user / mo</span></p>
                    ...
                    <div className="mx-auto max-w-5xl px-6">
                        <div className="grid gap-8 rounded-3xl border bg-gradient-to-b from-foreground/[0.02] to-transparent p-8 md:grid-cols-[1.2fr_0.8fr] md:p-10">
                            <div className="space-y-3">
                                <p className="text-sm font-semibold text-foreground/80">About</p>
                                <h3 className="text-3xl font-semibold leading-tight">Built for product teams who think in docs and diagrams.</h3>
                                <p className="text-muted-foreground text-base">
                                    Rethink Zone bundles writing, sketching, and delivery into one flow. The landing page mirrors the in-app experience so visitors know exactly what they get before signing in.
                                </p>
                                <div className="flex flex-wrap gap-3">
                                    <Badge variant="outline" className="rounded-full border-foreground/20 text-foreground/90">Docs + Canvas</Badge>
                                    <Badge variant="outline" className="rounded-full border-foreground/20 text-foreground/90">Kanban built-in</Badge>
                                    <Badge variant="outline" className="rounded-full border-foreground/20 text-foreground/90">Clerk auth</Badge>
                                </div>
                            </div>
                            <div className="rounded-2xl border bg-background/70 p-6 shadow-sm">
                                <p className="text-sm font-semibold text-foreground/80">Next steps</p>
