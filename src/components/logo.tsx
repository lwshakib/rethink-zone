...
export const CustomTextLogo = ({ className }: { className?: string }) => {
    return (
        <div className={cn('flex items-center gap-2 text-sm font-semibold text-foreground', className)}>
            <span className="bg-gradient-to-r from-[#9B99FE] to-[#2BC8B7] bg-clip-text text-base font-semibold text-transparent">
                Rethink
            </span>
        </div>
    )
