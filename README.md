<div align="center">
  ...
  **A premium, unified workspace that blends professional documents, an intelligent infinite canvas, and synchronized kanban boards.**
  ...
  <p align="center">
    <img src="public/dark_demo.png" alt="Rethink Zone Dark Mode" width="49%" style="border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);"/>
    <img src="public/light_demo.png" alt="Rethink Zone Light Mode" width="49%" style="border-radius: 8px; border: 1px solid rgba(0,0,0,0.1);"/>
  </p>
