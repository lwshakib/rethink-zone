...
test('should navigate to the home page and show the hero section', async ({ page }) => {
  // Start from the index page
  await page.goto('/')
  
  // Check for the main heading
  await expect(page.locator('h1')).toContainText('Rethink the way you write, sketch, and ship in one place.')
